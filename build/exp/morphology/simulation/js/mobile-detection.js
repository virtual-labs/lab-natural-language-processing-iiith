// Mobile Detection and Overlay Script for Morphology Experiment
// This script detects mobile devices and shows a landscape/desktop optimization warning
...
class MobileDetection {
      ...
      <div class="mobile-overlay-backdrop">
        <div class="mobile-overlay-content">
          ...
          <p class="mobile-overlay-description">
            This morphological analysis experiment is optimized for desktop computers with larger screens and mouse interaction. 
            While you can continue on mobile, you may experience:
          </p>
          <ul class="mobile-overlay-list">
            <li>• Difficulty interacting with dropdown menus</li>
            <li>• Limited screen space for the Add-Delete table</li>
            <li>• Reduced visibility of Hindi text and paradigms</li>
            <li>• Suboptimal user experience for morphological analysis</li>
          </ul>
          ...
          <p class="mobile-overlay-footer">
            For the best learning experience with Hindi morphology, please access this on a desktop or laptop computer.
          </p>
        </div>
      </div>
    `;
  ...
  goBack() {
    ...
    if (window.history.length > 1) {
      ...
      alert('Please bookmark this page and open it on a desktop computer for the best experience with Hindi morphological analysis.');
    }
  }
